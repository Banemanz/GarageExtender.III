...
namespace {
    ...
    int CapacityForSaveGarageIndex(int index) {
        switch (index) {
        case 0:
            return QUAD_PORTLAND_CAPACITY;
        case 1:
            return QUAD_STAUNTON_CAPACITY;
        case 2:
            return QUAD_SHORESIDE_CAPACITY;
        default:
            return index >= VANILLA_SAFEHOUSE_COUNT && index < TOTAL_SAFEHOUSE_COUNT ? EXTRA_HIDEOUT_CAPACITY : 0;
        }
    }
    ...
    void InstallPatches() {
        ...
        // Update() store/restore call capacities: Portland 1->4, Staunton 6->8, Shoreside 6->12.
        PatchByte(0x424A36, QUAD_PORTLAND_CAPACITY);
        PatchByte(0x424A3F, QUAD_STAUNTON_CAPACITY);
        PatchByte(0x424A48, QUAD_SHORESIDE_CAPACITY);
        ...
        PatchByte(0x428188, QUAD_PORTLAND_CAPACITY);
        PatchByte(0x428191, QUAD_STAUNTON_CAPACITY);
        PatchByte(0x42819A, QUAD_SHORESIDE_CAPACITY);
